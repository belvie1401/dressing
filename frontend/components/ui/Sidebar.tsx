...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-[220px] shrink-0 h-screen sticky top-0 border-r border-[#EFEFEF] bg-white py-6 px-4">
      {/* Logo */}
      <a href="/dashboard" className="font-serif text-xl text-[#111111] px-3 mb-8">
        LIEN
      </a>
      ...
      <a href="/profile" className="flex items-center gap-3 rounded-xl bg-[#F7F5F2] p-3 mt-4">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-medium text-[#111111] truncate">{user?.name || 'Camille D.'}</p>
          <p className="text-[11px] text-[#8A8A8A]">Voir mon profil</p>
        </div>
      </a>
    </aside>
  );
