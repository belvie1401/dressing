    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-b border-[#F0F0F0] px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          {isOnline && <span className="h-2 w-2 rounded-full bg-green-500" />}
        </div>
      </div>
      ...
      <div className="border-t border-[#F0F0F0] p-3">
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#F0EDE8] text-[#111111]"
