    ...
    <div className="min-h-screen bg-[#F7F5F2]">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-[#EFEFEF]">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          <Link href="/" className="flex flex-row items-center gap-2" style={{ flexDirection: 'row' }}><img src="/logo.png" alt="LIEN" style={{ height: '32px', width: 'auto', maxWidth: '32px', display: 'block', flexShrink: 0 }} /><span style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: '18px', color: '#111111', fontWeight: '400', letterSpacing: '0.05em', whiteSpace: 'nowrap', lineHeight: '1' }}>Lien</span></Link>
      ...
      <footer className="bg-[#111111] border-t border-[#222] py-8 px-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 md:flex-row md:justify-between">
          <Link href="/" className="flex flex-row items-center gap-2" style={{ flexDirection: 'row' }}><img src="/logo-white.png" alt="LIEN" style={{ height: '32px', width: 'auto', maxWidth: '32px', display: 'block', flexShrink: 0 }} /><span style={{ fontFamily: 'Playfair Display, Georgia, serif', fontSize: '18px', color: '#FFFFFF', fontWeight: '400', letterSpacing: '0.05em', whiteSpace: 'nowrap', lineHeight: '1' }}>Lien</span></Link>
